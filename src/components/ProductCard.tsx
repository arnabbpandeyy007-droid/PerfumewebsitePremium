    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden rounded bg-[#0A0A0A]">
        ...
        <button
          ...
          className="absolute top-3 right-3 w-8 h-8 rounded-full bg-black/50 flex items-center justify-center backdrop-blur-sm transition-all duration-300 hover:bg-black/70 z-10"
        >
          <Heart
